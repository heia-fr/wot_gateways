...
public abstract class BasicCoapChannel implements CoapChannel {
	...
	private final static Logger logger = Logger.getLogger(BasicCoapChannel.class); 
	protected SocketHandler socketHandler = null;
    protected ChannelManager channelManager = null;
    protected InetAddress remoteAddress;
    protected int remotePort;
    protected int localPort;
	protected CoapBlockSize maxReceiveBlocksize = null; //null means no block option
	protected CoapBlockSize maxSendBlocksize = null; //null means no block option

    public BasicCoapChannel(SocketHandler socketHandler, InetAddress remoteAddress, int remotePort) {
